...
let bagOpenButton = document.querySelector(".Character__bag__button");
let bagCloseButton = document.querySelector(".bag__close");
...
let bagItemsMenu = document.querySelector(".bag__items");
let bagAttacksMenu = document.querySelector(".bag__attacks");

let bagItemsContainer = document.querySelector(".bag__container__items");
let bagAttacksContainer = document.querySelector(".bag__container__attacks");
